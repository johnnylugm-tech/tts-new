...
|-------|-------------|------------------------|---------------------|--------|---------------------|
| FR-01 台灣中文詞彙映射 | `SRS.md §3 FR-01` (L153-L167) | `src/engines/taiwan_linguistic.py` (`SPEC.md L192`) | `tests/test_fr_01_taiwan_linguistic.py` | PLANNED | OK |
| FR-02 SSML 解析 | `SRS.md §3 FR-02` (L169-L183) | `src/engines/ssml_parser.py` (`SPEC.md L193`) | `tests/test_fr_02_ssml_parser.py` | PLANNED | OK |
| FR-03 智能文本切分 | `SRS.md §3 FR-03` (L185-L199) | `src/engines/text_splitter.py` (`SPEC.md L194`) | `tests/test_fr_03_text_splitter.py` (multi-tier) **+** `tests/test_fr_03_text_splitter_edge_cases.py` (proposed split) | PLANNED | OK |
| FR-04 並行合成 | `SRS.md §3 FR-04` (L201-L213) | `src/engines/synthesis.py` (`SPEC.md L195`) | `tests/test_fr_04_synthesis.py` (concurrency) **+** `tests/test_fr_04_synthesis_concat.py` (byte-level concatenation) | PLANNED | OK |
| FR-05 斷路器 | `SRS.md §3 FR-05` (L215-L228) | `src/middleware/circuit_breaker.py` (`SPEC.md L197`) | `tests/test_fr_05_circuit_breaker.py` | PLANNED | OK |
| FR-06 Redis 快取 (optional) | `SRS.md §3 FR-06` (L230-L241) | `src/cache/redis_cache.py` (`SPEC.md L198`) | `tests/test_fr_06_redis_cache.py` | PLANNED | OK |
| FR-07 CLI 工具 | `SRS.md §3 FR-07` (L243-L262) | `src/cli.py` (`SPEC.md L187`) | `tests/test_fr_07_cli.py` | PLANNED | OK |
| FR-08 ffmpeg 音訊格式轉換 | `SRS.md §3 FR-08` (L264-L274) | `src/audio_converter.py` (`SPEC.md L188`) | `tests/test_fr_08_audio_converter.py` | PLANNED | OK |
...
*End of TRACEABILITY_MATRIX — Kokoro Taiwan Proxy — v1.1 — harness-methodology v2.7.0.*
