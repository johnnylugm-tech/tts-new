...
### FR Implementation Tasks (8 total)
...
- **[P3-MIRROR]** Verify the RED test mirrors TEST_SPEC.md (P3 only implements — correctness was locked in P2; on FAIL fix the TEST, not TEST_SPEC):
  ```bash
  python3 harness_cli.py check-test-mirrors-spec --project . --fr-id FR-06 \
    --test-file 03-development/tests/test_fr06.py
  ```
  → trigger_mismatch / assertion_missing / param drift = test diverged from spec.
...
- **[ORCH-GREEN]** Dispatch TDD-GREEN sub-agent for FR-06:
  ...
  python3 harness_cli.py run-fr-step --phase 3 --fr-id FR-06 --step TDD-GREEN \
    --project . --srs 01-requirements/SRS.md
  ```
  → Verify: `pytest 03-development/tests/test_fr06.py -q` all pass
  → GitHub push: ✅ auto-done by run-fr-step
...
- **[ORCH-IMPROVE]** Dispatch TDD-IMPROVE sub-agent for FR-06:
  ...
  python3 harness_cli.py run-fr-step --phase 3 --fr-id FR-06 --step TDD-IMPROVE \
    --project .
  ```
  → Verify: `pytest 03-development/tests/test_fr06.py -q` still pass
  → GitHub push: ✅ auto-done by run-fr-step
...
- **[P3-MIRROR]** Verify the RED test mirrors TEST_SPEC.md (P3 only implements — correctness was locked in P2; on FAIL fix the TEST, not TEST_SPEC):
  ```bash
  python3 harness_cli.py check-test-mirrors-spec --project . --fr-id FR-07 \
    --test-file 03-development/tests/test_fr07.py
  ```
  → trigger_mismatch / assertion_missing / param drift = test diverged from spec.
...
- **[ORCH-GREEN]** Dispatch TDD-GREEN sub-agent for FR-07:
  ...
  python3 harness_cli.py run-fr-step --phase 3 --fr-id FR-07 --step TDD-GREEN \
    --project . --srs 01-requirements/SRS.md
  ```
  → Verify: `pytest 03-development/tests/test_fr07.py -q` all pass
  → GitHub push: ✅ auto-done by run-fr-step
...
- **[ORCH-IMPROVE]** Dispatch TDD-IMPROVE sub-agent for FR-07:
  ...
  python3 harness_cli.py run-fr-step --phase 3 --fr-id FR-07 --step TDD-IMPROVE \
    --project .
  ```
  → Verify: `pytest 03-development/tests/test_fr07.py -q` still pass
  → GitHub push: ✅ auto-done by run-fr-step
...
- **[P3-MIRROR]** Verify the RED test mirrors TEST_SPEC.md (P3 only implements — correctness was locked in P2; on FAIL fix the TEST, not TEST_SPEC):
  ```bash
  python3 harness_cli.py check-test-mirrors-spec --project . --fr-id FR-08 \
    --test-file 03-development/tests/test_fr08.py
  ```
  → trigger_mismatch / assertion_missing / param drift = test diverged from spec.
...
- **[ORCH-GREEN]** Dispatch TDD-GREEN sub-agent for FR-08:
  ...
  python3 harness_cli.py run-fr-step --phase 3 --fr-id FR-08 --step TDD-GREEN \
    --project . --srs 01-requirements/SRS.md
  ```
  → Verify: `pytest 03-development/tests/test_fr08.py -q` all pass
  → GitHub push: ✅ auto-done by run-fr-step
...
- **[ORCH-IMPROVE]** Dispatch TDD-IMPROVE sub-agent for FR-08:
  ...
  python3 harness_cli.py run-fr-step --phase 3 --fr-id FR-08 --step TDD-IMPROVE \
    --project .
  ```
  → Verify: `pytest 03-development/tests/test_fr08.py -q` still pass
  → GitHub push: ✅ auto-done by run-fr-step
